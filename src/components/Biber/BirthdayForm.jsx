...
const BirthdayForm = ({ birthday, setBirthday, onConfirm, error, state = {} }) => (
    <div className="mb-3">
        ...
        {!state.UI.HIDE_BIRTHDAY_SUBMIT_BUTTON &&
            <button className="btn btn-success mt-3" type="button" onClick={onConfirm} disabled={state.UI.ENABLE_BIRTHDAY_SUBMIT_BUTTON ? "" : "disabled"}>
                Auswahl bestätigen
            </button>
        }
