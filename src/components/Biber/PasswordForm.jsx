...
const PasswordForm = ({ state, onInsertPassword, onPasswordSubmit }) => (
  <div className="mb-3">
    <label htmlFor="passwordInput" className="form-label fw-bold">
      Gib den Zugangscode ein, welcher dir durch deinen Info- oder Mathelehrer
      mitgeteilt wurde.
    </label>
    <input
      ...
      autoComplete="off"
      disabled={!state.UI.HIDE_PASSWORD_SUBMIT_BUTTON ? "" : "disabled"}
    />
    ...
    {state.ERRORS.ENTRY_CODE && (
      <div className="alert alert-danger mt-3" role="alert">
        Der Zugangscode scheint falsch zu sein. Versuche es erneut. Lade ggf.
        die Seite neu.
      </div>
    )}
  </div>
