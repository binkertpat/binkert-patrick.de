        ...
        <>
            ...
            <form className="row g-3" method="POST" action={isBot} onMouseMove={handleBotCheck}>
                <div className="col-md-6">
                    ...
                    <input type="text" className="form-control" id="firstname" name="firstname" placeholder="Max" value={firstname} onChange={handleFirstNameChange} />
                </div>
                <div className="col-md-6">
                    <label htmlFor="lastname" className="form-label fw-bold">Nachname</label>
                    <input type="text" className="form-control" id="lastname" name="lastname" placeholder="Mustermann" value={lastname} onChange={handleLastNameChange} />
                </div>
                <div className="col-12">
                    <label htmlFor="email" className="form-label fw-bold">E-Mail-Adresse</label>
                    <input type="email" className="form-control" id="email" name="email" placeholder="ntuzer@beispiel.de" value={email} onChange={handleEmailChange} />
                </div>
                <div className="col-12">
                    <label htmlFor="reference" className="form-label fw-bold">Betreff</label>
                    <input type="text" className="form-control" id="reference" name="reference" placeholder="Betreff ..." value={reference} onChange={handleReferenceChange} />
                </div>
                <div className="col-12">
                    <label htmlFor="issue" className="form-label fw-bold">Dein Anliegen</label>
                    <textarea className="form-control" id="issue" name="issue" rows="10" placeholder="Sehr geehrter Herr Binkert, ..." value={issue} onChange={handleIssueChange}></textarea>
                </div>
                <div className="col-12">
