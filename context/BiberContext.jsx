...
const DEFAULT_STATE = {
  ...
  UI: {
    ENABLE_PASSWORD_SUBMIT_BUTTON: false,
    HIDE_PASSWORD_SUBMIT_BUTTON: false,
    SHOW_CLASS_AREA: false,
    ENABLE_CLASS_SUBMIT_BUTTON: false,
    HIDE_CLASS_SUBMIT_BUTTON: false,
    SHOW_STUDENT_AREA: false,
    ENABLE_STUDENT_SUBMIT_BUTTON: false,
    HIDE_STUDENT_SUBMIT_BUTTON: false,
    SHOW_BIRTHDAY_AREA: false,
    ENABLE_BIRTHDAY_SUBMIT_BUTTON: false,
    HIDE_BIRTHDAY_SUBMIT_BUTTON: false,
